...
{
    public class Sub1PageViewModel : BindableBase, INavigationAware
    {
        ...
        public Sub1PageViewModel(INavigationService navigationService)
        {
        ...
        public async void OnNavigatedTo(NavigationParameters parameters)
        {
            if (parameters.ContainsKey("Auto"))
            {
                ...
                var Next = "Sub3Page";
                await _navigationService.NavigateAsync($"{isAuto}?Auto={Next}");
            }
